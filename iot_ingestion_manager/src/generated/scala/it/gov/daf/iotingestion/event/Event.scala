 ...
 * @param event_subtype_id It's an additional field that can be used to additionally qualify the event. It is used with SOURCE attribute for identifying uniquely a timeseries. Optional.
