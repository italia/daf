...
You'll find the [DCATAP schema here](md-dcatapit.json) and an [example application here](example/data-dcatapit.json)
...
You'll find the [DataSchema schema here](md-dataschema.json) and an [example application here](example/data-dataschema.json)
...
You'll find the [Operational schema here](md-operational.json) and an [example application here](example/data-operational.json)
