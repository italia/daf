package it.gov.daf.swaggergenerators
...
/**
  *
  * This is a specialised version of the swagger-codegen sbt plugin, it's used for adding an extra header parameter for supporting
  * the call authenticationn
  *
  */
