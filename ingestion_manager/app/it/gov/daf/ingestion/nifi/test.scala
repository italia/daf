...
//    }
//    val voc_dcatap2dafsubtheme = voc_dcatap2dafsubthemeAction { input: (String, String) =>
...
//      val themeList: Seq[KeyValue] = VocServiceRegistry.vocRepository.listDcatapitThemeAll()
...
//    }
//    val voc_daf2dcatapsubtheme = voc_daf2dcatapsubthemeAction { input: (String, String) =>
//      val (themeid, subthemeid) = input
...
//    }
//    val voc_dcatap2Daftheme = voc_dcatap2DafthemeAction { (themeid: String) =>
...
//    }
//    val voc_daf2dcataptheme = voc_daf2dcatapthemeAction { (themeid: String) =>
...
//      val themeList: Seq[KeyValue] = VocServiceRegistry.vocRepository.listDcatapItSubtheme(themeid)
