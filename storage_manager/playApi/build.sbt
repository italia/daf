...
lazy val root = (project in file(".")).enablePlugins(PlayScala, AutomateHeaderPlugin, DockerPlugin)//.dependsOn(common)

//lazy val common = (project in file("common")).
//  settings(Seq(
//    name := "daf-storage-manager-common",
//    version := sys.env.getOrElse("STORAGE_MANAGER_VERSION", "1.0.0-SNAPSHOT")
//  ))
